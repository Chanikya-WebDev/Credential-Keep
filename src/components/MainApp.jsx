        ...
        <main className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <input type="text" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} placeholder="Search website, username, etc..." className="w-full p-2 mb-4 bg-gray-700 rounded-md border border-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
